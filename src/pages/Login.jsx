                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="w-full px-5 py-4 pr-12 bg-surface-50 border border-surface-200 rounded-xl focus:ring-2 focus:ring-brand-500 focus:border-brand-500 shadow-sm transition-all focus:bg-white outline-none font-medium text-surface-900"
                                placeholder="••••••••"
                            />
                            <button
                                type="button"
